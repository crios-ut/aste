...
/* ASTE definitions */
/*  -- to do: document what this means :) -- */
#define __ncut1 150
#define __ncut2  60
#define __nobcs   4
...
C $Header: /u/gcmpack/MITgcm_contrib/llc_hires/llc_90/code-async/SIZE.h,v 1.1 2019/03/03 01:17:30 dimitri Exp $
C $Name:  $
C
CBOP
C    !ROUTINE: SIZE.h
