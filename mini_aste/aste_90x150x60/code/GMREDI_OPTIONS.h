C $Header: /u/gcmpack/MITgcm_contrib/gael/verification/global_oce_llc90/code/GMREDI_OPTIONS.h,v 1.4 2014/10/21 04:56:23 gforget Exp $
C $Name:  $
...
C#define ALLOW_KAPGM_CONTROL
C#define ALLOW_KAPREDI_CONTROL

C Designed to simplify the Ajoint code:
#define GMREDI_WITH_STABLE_ADJOINT

C o Allow full 3D GMfields 
